<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="System_Tools.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="System_Tools" %>
